...
public class SimpleMailServlet extends HttpServlet {
	...
	public String SendSimpleMessage(String name, String emailId, String message) {
		...
		client.addFilter(new HTTPBasicAuthFilter("api", "key-61f5c5ad90ed0752759c11abf3231944"));
		WebResource webResource = client.resource("https://api.mailgun.net/v3/www.dineshjaju.com" + "/messages");
		...
		webResource.type(javax.ws.rs.core.MediaType.APPLICATION_FORM_URLENCODED).post(ClientResponse.class, formData);
